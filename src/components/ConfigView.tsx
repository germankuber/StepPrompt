              ...
              <div>
                ...
                <div className="space-y-2">
                  {defaultModels.map((model) => (
                    <label
                      key={model.value}
                      className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${activeModel === model.value
                  ...
                  {customModels.map((model) => (
                    <label
                      key={model}
                      className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${activeModel === model
                        ? 'border-blue-500 bg-blue-50 ring-1 ring-blue-500'
                        : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                        }`}
                    >
